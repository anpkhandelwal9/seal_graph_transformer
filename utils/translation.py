...
#/home/jasmine/Torch_practice/data/wmt32k/training-parallel-commoncrawl.tgz

    @classmethod
    def splits(cls, exts, fields, data_dir, root='/home/jasmine/Torch_practice/data/', **kwargs):
        ...
        print(map(lambda x: os.path.join(path, x), train_files))
